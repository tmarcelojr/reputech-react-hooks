...
export default function App() {
  ...
  useEffect(() => {
    async function getCompanyData() {
      try{
        const companyDataRes = await fetch('http://reputech-python.herokuapp.com/api/v1/companies/')
    ...
    async function getCompanyReviews() {
      try{
        const reviewsRes = await fetch('http://reputech-python.herokuapp.com/api/v1/reviews/')
    ...
    async function getRatings() {
      try{
        const ratingRes = await fetch('http://reputech-python.herokuapp.com/api/v1/collected_reviews/')
  ...
  useEffect(() => {
    async function getFavorites() {
      try{
        const favoritesRes = await fetch('http://reputech-python.herokuapp.com/api/v1/favorites/')
  ...
  const addFavorite = async (id) => {
    ...
    try{
      const addFavoriteRes = await fetch('http://reputech-python.herokuapp.com/api/v1/favorites/' + companyId, {
          credentials: 'include',
          method: 'POST',
          headers: {
   ...
   const removeFavorite = async (id) => {
    const companyId = id.toString()
    try{
      const removeFavoriteRes = await fetch('http://reputech-python.herokuapp.com/api/v1/favorites/' + companyId, {
          credentials: 'include',
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json'
  ...
  const checkLoginStatus = async () => {
    try{
      const checkLoginRes = await fetch('http://reputech-python.herokuapp.com/api/v1/users/logged_in', {
          credentials: 'include',
          method: 'GET',
          headers: {
            'Content-Type': 'application/json'
  ...
  const logout = async () => {
    try {
      const logoutRes = await fetch('http://reputech-python.herokuapp.com/api/v1/users/logout', {
          credentials: 'include',
          method: 'GET',
          headers: {
            'Content-Type': 'application/json'
